    ...
    <?php
     ...
     if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
          echo " /Ano: " . $row["ano"]. "  " . "/Mes: " . $row["mes"]. " " . "/Dia: ". $row["dia"]. " " . "/Tipo: ". $row["tipo"]. " " . "/Descrição: ". $row["descricao"]. " " . "/Valor: ". $row["valor"]. "  " . "<a href='consulta/editar.php?id=". $row["id"]."'> Editar </a>" . "  " . "<a href='consulta/remove.php?id=". $row["id"]."'> Excluir </a> <br>";
        }
     } else {
      echo "0 results";
      }
