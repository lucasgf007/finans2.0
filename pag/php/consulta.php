    ...
    <?php
     ...
     if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
          echo " /Ano: " . $row["ano"]. "  " . "/Mes: " . $row["mes"]. " " . "/Dia: ". $row["dia"]. " " . "/Tipo: ". $row["tipo"]. " " . "/Descrição: ". $row["descricao"]. " " . "/Valor: ". $row["valor"]. "<a href='editar.php?id=". $row["id"]."'> <img src=\"../img/lapis.png\"/ style='width= 20px;'  alt='Editar'> </a> <br>";
        }
     } else {
      echo "0 results";
      }
